...
return [
    ...
    "Invalid input image - format must be in ['RGBA'], got RGB." => '图片色彩不正确，或者您这张图片需要一个透明的蒙层，请用Photoshop或其他软件编辑一下',
    'You exceeded your current quota, please check your plan and billing details.' => '您超出了当前的配额，请检查您的计划和账单细节。',
];
