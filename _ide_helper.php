...
namespace Illuminate\Support\Facades {
    ...
    class Request
    {
         ...
         * @return null|\Illuminate\Http\TEnum
         * @static
         */
...
')
    ...
    class Vite
    {
         ...
         *
         * @static
         * @param null|mixed $buildDirectory
         * @return null|string
         */
...
namespace Spatie\LaravelIgnition\Facades {
    ...
    class Flare
    {
        ...
        /**
         * @param array<FlareMiddleware>|\Spatie\FlareClient\class-string<FlareMiddleware>|\Spatie\FlareClient\FlareMiddleware\FlareMiddleware $middleware
